...
import com.equipo2.healthtech.dto.encounter.EncounterWithAppointmentReadSummaryDto;
...
@Mapper(componentModel = "spring", uses = { AppointmentMapper.class }, unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface EncounterMapper {
    ...
    @Mapping(source = "patientId", target = "patient", qualifiedByName = "mapPatientFromEncounterDto")
    ...
    EncounterWithAppointmentReadSummaryDto toEncounterWithAppointmentReadSummaryDto(Encounter encounter);
    ...
    @Named("mapPatientFromEncounterDto")
    default Patient mapPatientFromEncounterDto(Long id) {
        if (id == null) return null;
